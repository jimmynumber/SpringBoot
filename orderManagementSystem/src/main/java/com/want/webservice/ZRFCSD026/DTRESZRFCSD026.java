...
/**
 * <p>DT_RES_ZRFCSD026 complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="DT_RES_ZRFCSD026"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "DT_RES_ZRFCSD026", propOrder = {
    "itvbak",
    "itvbap",
    "otvbak",
    "otvbap"
})
public class DTRESZRFCSD026 {

    @XmlElement(name = "IT_VBAK")
    protected List<DTRESZRFCSD026 .ITVBAK> itvbak;
    @XmlElement(name = "IT_VBAP")
    protected List<DTRESZRFCSD026 .ITVBAP> itvbap;
    @XmlElement(name = "OT_VBAK")
    protected List<DTRESZRFCSD026 .OTVBAK> otvbak;
    @XmlElement(name = "OT_VBAP")
    protected List<DTRESZRFCSD026 .OTVBAP> otvbap;
     ...
     * {@link DTRESZRFCSD026 .ITVBAK }
     * 
     * 
     */
    public List<DTRESZRFCSD026 .ITVBAK> getITVBAK() {
        if (itvbak == null) {
            itvbak = new ArrayList<DTRESZRFCSD026 .ITVBAK>();
        }
        return this.itvbak;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DTRESZRFCSD026 .ITVBAP }
     * 
     * 
     */
    public List<DTRESZRFCSD026 .ITVBAP> getITVBAP() {
        if (itvbap == null) {
            itvbap = new ArrayList<DTRESZRFCSD026 .ITVBAP>();
        }
        return this.itvbap;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DTRESZRFCSD026 .OTVBAK }
     * 
     * 
     */
    public List<DTRESZRFCSD026 .OTVBAK> getOTVBAK() {
        if (otvbak == null) {
            otvbak = new ArrayList<DTRESZRFCSD026 .OTVBAK>();
        }
        return this.otvbak;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DTRESZRFCSD026 .OTVBAP }
     * 
     * 
     */
    public List<DTRESZRFCSD026 .OTVBAP> getOTVBAP() {
        if (otvbap == null) {
            otvbap = new ArrayList<DTRESZRFCSD026 .OTVBAP>();
        }
        return this.otvbap;
    }
