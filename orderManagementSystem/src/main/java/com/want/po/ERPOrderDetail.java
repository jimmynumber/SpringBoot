...
public class ERPOrderDetail{
    ...
    private Double rebateDiscountPrice;
    private Double sumAmount;
    private String createUser;
    private Date createDate;
    private String orderLineType;
    private String promoteId;
    private String promotePolicyDesc;
	...
	public Double getRebateDiscountPrice() {
		return rebateDiscountPrice;
	}
	public void setRebateDiscountPrice(Double rebateDiscountPrice) {
