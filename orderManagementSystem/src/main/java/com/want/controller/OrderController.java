...
public class OrderController {
    ...
    public Map<String,Object> updateErpOrders(@RequestBody ErpOrderDetailVoList erpOrderDetailVoList) {
    	LOGGER.info("OrderController.updateErpOrders ErpOrderDetailVoList:{} ",erpOrderDetailVoList.toString());
    ...
    public Map<String,Object> modifyErpOrderDetail(@RequestBody ErpOrderDetailVo erpOrderDetailVo ) {
